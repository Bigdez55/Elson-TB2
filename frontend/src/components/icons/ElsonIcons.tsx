...
export const AutoTradingIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const ExclamationCircleIcon: React.FC<IconProps> = ({ className, style }) => (
  <svg className={className} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
// Icons object for backward compatibility
export const Icons = {
  Search: SearchIcon,
  Bell: BellIcon,
  Help: HelpIcon,
