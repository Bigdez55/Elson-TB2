          ...
          >
            <div className="flex items-center justify-between mb-1">
              ...
              <div className="text-right">
                <div className="font-semibold">{formatCurrency(investment.investment_amount || investment.amount || 0)}</div>
            ...
            <div className="grid grid-cols-2 gap-4 text-sm mt-2">
              <div>
                ...
                <div>{investment.start_date ? formatDate(investment.start_date) : 'N/A'}</div>
              </div>
              <div>
            ...
            {investment.is_active && (
              <div className="mt-3 flex justify-end">
                <button
                  onClick={(e) => investment.id && handleCancelInvestment(investment.id, e)}
