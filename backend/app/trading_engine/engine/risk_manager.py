...
class RiskManager:
    ...
    async def calculate_position_size(
        ...
        try:
            ...
            metrics = self.portfolio_metrics or await self._calculate_portfolio_metrics(portfolio)
    ...
    async def _calculate_portfolio_metrics(self, portfolio: Portfolio) -> Dict:
        ...
        try:
            ...
            portfolio_returns = self._calculate_weighted_returns(position_returns, portfolio)
    ...
    def _calculate_weighted_returns(
        ...
        weighted_returns = pd.Series(0, index=next(iter(position_returns.values())).index)
    ...
    async def check_correlation_limits(self, new_symbol: str, portfolio: Portfolio) -> bool:
