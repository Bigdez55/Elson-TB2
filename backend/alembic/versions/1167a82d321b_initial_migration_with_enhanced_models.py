...
def upgrade() -> None:
    ...
    op.create_index('idx_symbol_timestamp_sentiment', 'market_sentiment', ['symbol', 'timestamp'], unique=False)
    ...
    op.create_index('idx_symbol_indicator_timestamp', 'technical_indicators', ['symbol', 'indicator_name', 'timestamp'], unique=False)
    ...
    sa.Column('order_type', sa.Enum('MARKET', 'LIMIT', 'STOP', 'STOP_LOSS', 'STOP_LIMIT', name='ordertype'), nullable=False),
    sa.Column('quantity', sa.Float(), nullable=False),
    ...
    sa.Column('status', sa.Enum('PENDING', 'FILLED', 'PARTIALLY_FILLED', 'CANCELLED', 'REJECTED', name='tradestatus'), nullable=True),
    ...
    op.create_index(op.f('ix_trades_external_order_id'), 'trades', ['external_order_id'], unique=False)
