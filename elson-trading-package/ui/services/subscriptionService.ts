...
export const subscriptionService = {
  ...
  async getActiveSubscription(forceRefresh = false): Promise<Subscription | null> {
    try {
  ...
  async getAllSubscriptions(forceRefresh = false): Promise<Subscription[]> {
    try {
  ...
  async getSubscription(id: number, forceRefresh = false): Promise<Subscription> {
    try {
  ...
  async checkFeatureAccess(feature: string, forceRefresh = false): Promise<FeatureAccessResponse> {
    try {
