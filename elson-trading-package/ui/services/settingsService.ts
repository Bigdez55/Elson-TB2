...
export const settingsService = {
  async getTradingSettings(forceRefresh = false): Promise<TradingSettings> {
    try {
  ...
  async getNotificationSettings(forceRefresh = false): Promise<NotificationSettings> {
    try {
  ...
  async getUISettings(forceRefresh = false): Promise<UISettings> {
    try {
  ...
  async getAPIKeys(forceRefresh = false): Promise<APIKeySettings[]> {
    try {
