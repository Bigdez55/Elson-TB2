...
def encrypt_file(input_path: Union[str, Path], output_path: Union[str, Path], encryptor: Optional[Union[AES256Encryptor, FernetEncryptor]] = None) -> None:
    """
...
def decrypt_file(input_path: Union[str, Path], output_path: Union[str, Path], encryptor: Optional[Union[AES256Encryptor, FernetEncryptor]] = None) -> None:
    """
