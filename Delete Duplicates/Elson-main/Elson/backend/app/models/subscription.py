...
from .user import SubscriptionPlan, BillingCycle
...
class Subscription(Base):
    ...
    paypal_agreement_id = Column(String, nullable=True)  # Billing agreement ID for recurring payments
...
class SubscriptionPayment(Base):
    ...
    provider_payment_data = Column(JSONB, nullable=True)  # Additional data from payment processor
...
class SubscriptionHistory(Base):
    ...
    change_data = Column(JSONB, nullable=True)  # Contains details of what changed
