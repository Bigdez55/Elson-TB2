...
from app.models.trade import Trade, TradeStatus, TradeType, TradeSide
...
def test_portfolio(mock_db_session, test_user):
    ...
    mock_db_session.query.return_value.filter.return_value.first.return_value = portfolio
    return portfolio
...
class TestTradingPipeline:
    ...
    def test_trade_with_risk_validation_failure(
        ...
        mock_risk_service.validate_trade.return_value = (
            False, "Trade exceeds portfolio concentration limits"
        )
